...
export default function App(){
  //'users' e 'setUsers' são e variável e a função de atualização respectivamente
  const[users, setUsers] = useState([]);

  const API = "http://10.110.12.32:3000/users";
  ...
  async function fetchUsers() {
    try{
      ...
      // Se ocorrer erro (ex: falha de conexão), exibe
